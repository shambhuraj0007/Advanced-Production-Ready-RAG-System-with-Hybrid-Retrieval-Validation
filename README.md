...
```
*Access the interactive Streamlit UI at `http://localhost:8501` to upload documents, configure hybrid search parameters, query the system, and view grounded citations.*
